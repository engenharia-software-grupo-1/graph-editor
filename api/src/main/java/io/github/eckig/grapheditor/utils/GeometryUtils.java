...
public class GeometryUtils
{
     ...
     *
     * @param event
     *         a {@link MouseEvent} storing the cursor position
     * @param node
     *         some {@link Node}
     ...
     *
     * @param jointSkins
     *         a list of joint skin instances
    ...
    public static Point2D getJointPosition(final GJoint joint, final SkinLookup skinLookup)
    {
        ...
        final var y = region.getLayoutY() + jointSkin.getHeight() / 2;
     ...
     *
     * @param position
     *         the position to move off-pixel
     ...
     *
     * @param firstValue
     *         an x or y position value
     * @param secondValue
     *         another x or y position value
     * @param position
     *         the cursor's position value
     ...
     *
     * @param a
     *         start of line segment AB
     * @param b
     *         end of line segment AB
     * @param c
     *         start of line segment CD
     * @param d
     *         end of line segment CD
